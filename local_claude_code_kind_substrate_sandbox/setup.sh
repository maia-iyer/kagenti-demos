...
echo ""
echo "     Every sandbox command prints a banner as the first line of stdout"
echo "     ('[sandbox <actor> alpine] \$ ...'), and the PreToolUse hook will"
echo "     deny any local Bash call that isn't routed through the sandbox."
